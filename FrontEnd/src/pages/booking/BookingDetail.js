  ...
  return (
    <div className="app-wrapper d-flex flex-column min-vh-100">
      ...
      <div className="container my-5">
        ...
        <div className="row mt-5 gx-5">
          <div className="col-md-6">
            <div className="p-4 border rounded-3 shadow-sm bg-light">
              <h4 className="mb-3 text-primary fw-bold">{room.roomType}</h4>
          ...
          <div className="col-md-6">
            <div className="p-4 border rounded-3 shadow-sm bg-white">
              <h5 className="text-dark fw-semibold mb-3">Room Information</h5>
              <p><strong>Room Capacity:</strong> {room.roomCapacity} guest(s)</p>
              <p><strong>Room Price:</strong> ${room.roomPrice} per night</p>
              <p className="mb-2">
                <span className="text-success fw-bold">✔ Pay at Hotel</span>
                <span className="text-muted ms-2">(Pay when you check-in at the property)</span>
              </p>
              <p className="mb-2">
                <span className="text-muted fw-bold">✔ Cancellation Policy Applies</span>
                <span className="text-muted ms-2">(Free cancellation within 3 days before check-in)</span>
              </p>
        ...
        {/* GIỮ NGUYÊN PHẦN YOU MAY ALSO LIKE */}
        ...
        <div className="my-5">
          ...
          <div className="position-relative" style={{ padding: "0 60px" }}>
            ...
            <button className="carousel-control-prev" type="button" data-bs-target="#suggestedRoomsCarousel" data-bs-slide="prev"
              style={{ position: "absolute", top: "50%", left: "-50px", transform: "translateY(-50%)", zIndex: 2 }}>
              <span className="carousel-control-prev-icon" aria-hidden="true"></span>
              <span className="visually-hidden">Previous</span>
            </button>
            <button className="carousel-control-next" type="button" data-bs-target="#suggestedRoomsCarousel" data-bs-slide="next"
              style={{ position: "absolute", top: "50%", right: "-50px", transform: "translateY(-50%)", zIndex: 2 }}>
              <span className="carousel-control-next-icon" aria-hidden="true"></span>
              <span className="visually-hidden">Next</span>
            </button>
          </div>
