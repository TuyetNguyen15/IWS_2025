                            ...
                            <div className="room-cardb">
                                ...
                                <div className="content">
                                    ...
                                    <div className="room-features flex justify-between w-full gap-4">
                                        ...
                                        <div className="flex flex-1 items-center p-2 text-center border rounded-md" style={{ width: '100px' }}>
                                    ...
                                    <div className="d-flex justify-content-between align-items-center mt-2">
                                        <Link to={`/rooms/${room.id}`} className="btn" style={{ backgroundColor: "#edeaea", color: "#a5a5a5" }}>
    Details
</Link>
